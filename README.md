...
- **タグ機能**: ギャラリーで複数の動画を選択し、ローカル保存のタグを一括追加できます。タグをクリックすると該当動画だけに絞り込めます
...
- **検索ボタン（虫眼鏡アイコン）**: サムネイル一覧を表示して検索バーにフォーカス
  ...
  - 動画を選択すると、画面下部の検索バーがタグ追加バーに切り替わります
  - タグ追加バーの上段に既存タグがチップとして表示され、クリックで入力欄に追加できます
  - タグ追加バーにタグ名を入力して「タグ追加」を押すと、選択中の動画へ一括でタグを追加できます
  - タグはカンマ区切りで複数追加できます
