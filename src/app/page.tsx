      ...
      <div className="h-full w-full flex items-center justify-center relative group bg-black">
        ...
        <div className={`absolute bottom-0 left-0 right-0 p-10 pb-6 pt-32 bg-gradient-to-t from-black/90 via-black/40 to-transparent pointer-events-none z-20 transition-opacity duration-300 ${
          ...
          <div className="max-w-2xl">
            {currentVideo.prompt && (
              <div className="group/prompt relative text-white text-base font-light leading-relaxed drop-shadow-2xl mb-2 flex items-start gap-2.5 pointer-events-auto select-text">
                <div className="flex-1 line-clamp-4">
                  {renderPromptText(currentVideo.prompt)}
                </div>
                <button
                  onClick={handleCopyPrompt}
                  className="shrink-0 p-1.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white/40 hover:text-white transition-all hover:scale-105 active:scale-95 cursor-pointer focus:outline-none flex items-center justify-center"
